...
public class TC_99471_002_VerifyUpdatedIncentiveInList extends TestBase{
	 public static final Logger log=Logger.getLogger(TC_99471_002_VerifyUpdatedIncentiveInList.class.getName());
	    SignInPage signin;
...
@Test
public void verifyUpdatedIncentive() throws Exception{
	updateIncentiveListViewPage= new UpdateIncentiveListViewPage(driver);
	updateIncentiveListViewPage.VerifyUpdatedIncentiveInList();
	}
}